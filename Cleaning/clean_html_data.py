from clean_body import  remove_in_text_references_text, remove_stopwords_and_non_alpha
import pandas as pd
...
stopwords_final = stopwords_nltk + stopwords_technical_add + stopwords_TN_add + stopwords_USTPO


df_jom['body'] = df_jom['body'].apply(remove_stopwords_and_non_alpha, stopword_list = stopwords_final)
df_jomr['body'] = df_jomr['body'].apply(remove_stopwords_and_non_alpha, stopword_list = stopwords_final)
df_jcr['body'] = df_jcr['body'].apply(remove_stopwords_and_non_alpha, stopword_list = stopwords_final)
df_jcp['body'] = df_jcp['body'].apply(remove_stopwords_and_non_alpha, stopword_list = stopwords_final)
df_jam['body'] = df_jam['body'].apply(remove_stopwords_and_non_alpha,stopword_list = stopwords_final)



df_jom['abstract'] = df_jom['abstract'].apply(remove_stopwords_and_non_alpha, stopword_list = stopwords_final)
df_jomr['abstract'] = df_jomr['abstract'].apply(remove_stopwords_and_non_alpha, stopword_list = stopwords_final)
df_jcr['abstract'] = df_jcr['abstract'].apply(remove_stopwords_and_non_alpha, stopword_list = stopwords_final)
df_jcp['abstract'] = df_jcp['abstract'].apply(remove_stopwords_and_non_alpha, stopword_list = stopwords_final)
df_jam['abstract'] = df_jam['abstract'].apply(remove_stopwords_and_non_alpha,stopword_list = stopwords_final)
